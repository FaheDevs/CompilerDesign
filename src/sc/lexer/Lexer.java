...
public class Lexer
{
    ...
    Token new30(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TPointIntero(line, pos); }
    Token new31(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TPoints(line, pos); }
    Token new32(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TInc(line, pos); }
...
/*  {
        { // INITIAL
            {{10, 10, 1}, {13, 13, 2}, {32, 32, 3}, {33, 33, 4}, {35, 35, 5}, {36, 36, 6}, {38, 38, 7}, {40, 40, 8}, {41, 41, 9}, {42, 42, 10}, {43, 43, 11}, {44, 44, 12}, {45, 45, 13}, {47, 47, 14}, {48, 57, 15}, {58, 58, 16}, {59, 59, 17}, {60, 60, 18}, {61, 61, 19}, {63, 63, 20}, {65, 90, 6}, {91, 91, 21}, {93, 93, 22}, {95, 95, 6}, {97, 97, 23}, {98, 100, 6}, {101, 101, 24}, {102, 102, 25}, {103, 107, 6}, {108, 108, 26}, {109, 113, 6}, {114, 114, 27}, {115, 115, 28}, {116, 116, 29}, {117, 122, 6}, {123, 123, 30}, {124, 124, 31}, {125, 125, 32}, },
            {{10, 32, -2}, },
            {{10, 32, -2}, },
            {{10, 32, -2}, },
            {},
            ...
            {{48, 104, -28}, {105, 105, 44}, {106, 122, 36}, },
            ...
            {{48, 122, -8}, },
            {},
            {{48, 90, -8}, {97, 110, 36}, {111, 111, 47}, {112, 122, 36}, },
            {{48, 90, -8}, {97, 113, 36}, {114, 114, 48}, {115, 122, 36}, },
            {{48, 90, -8}, {97, 115, 36}, {116, 116, 49}, {117, 122, 36}, },
            {{48, 104, -28}, {105, 105, 50}, {106, 122, 36}, },
            {{48, 113, -41}, {114, 114, 51}, {115, 122, 36}, },
            {{48, 115, -42}, {116, 116, 52}, {117, 122, 36}, },
            {{48, 90, -8}, {97, 109, 36}, {110, 110, 53}, {111, 122, 36}, },
            {{48, 109, -46}, {110, 110, 54}, {111, 122, 36}, },
            {},
            {{48, 113, -41}, {114, 114, 55}, {115, 122, 36}, },
            {{48, 104, -28}, {105, 105, 56}, {106, 122, 36}, },
            {{48, 104, -28}, {105, 105, 57}, {106, 122, 36}, },
            {{48, 113, -41}, {114, 114, 58}, {115, 122, 36}, },
            {{48, 100, -29}, {101, 101, 59}, {102, 122, 36}, },
            {{48, 110, -40}, {111, 111, 60}, {112, 122, 36}, },
            {{48, 110, -40}, {111, 111, 61}, {112, 122, 36}, },
            {{48, 115, -42}, {116, 116, 62}, {117, 122, 36}, },
            {{48, 90, -8}, {97, 114, 36}, {115, 115, 63}, {116, 122, 36}, },
            {{48, 113, -41}, {114, 114, 64}, {115, 122, 36}, },
            {{48, 100, -29}, {101, 101, 65}, {102, 122, 36}, },
            {{48, 100, -29}, {101, 101, 66}, {102, 122, 36}, },
            {{48, 122, -8}, },
            {{48, 90, -8}, {97, 116, 36}, {117, 117, 67}, {118, 122, 36}, },
            {{48, 109, -46}, {110, 110, 68}, {111, 122, 36}, },
            {{48, 90, -8}, {97, 112, 36}, {113, 113, 69}, {114, 122, 36}, },
            {{48, 122, -8}, },
            {{48, 100, -29}, {101, 101, 70}, {102, 122, 36}, },
            {{48, 113, -41}, {114, 114, 71}, {115, 122, 36}, },
            {{48, 122, -8}, },
            {{48, 113, -41}, {114, 114, 72}, {115, 122, 36}, },
            {{48, 122, -8}, },
            {{48, 116, -62}, {117, 117, 73}, {118, 122, 36}, },
            {{48, 122, -8}, },
            {{48, 122, -8}, },
            {{48, 122, -8}, },
            {{48, 100, -29}, {101, 101, 74}, {102, 122, 36}, },
            {{48, 122, -8}, },
        }
    };*/
...
/*  {
        // INITIAL
        {-1, 0, 0, 0, 17, -1, 29, 15, 7, 8, 5, 18, 2, 6, 3, 28, 31, 4, 14, 13, 30, 9, 10, 29, 29, 29, 29, 29, 29, 29, 11, 16, 12, -1, 1, 1, 29, 32, 29, 29, 29, 29, 29, 29, 19, 29, 1, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 26, 29, 29, 29, 20, 29, 29, 23, 29, 21, 29, 27, 24, 25, 29, 22, },
