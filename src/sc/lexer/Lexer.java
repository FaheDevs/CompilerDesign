...
/*  {
        { // INITIAL
            ...
            {{48, 90, -8}, {97, 98, 36}, {99, 99, 38}, {100, 109, 36}, {110, 110, 39}, {111, 122, 36}, },
            {{48, 90, -8}, {97, 97, 40}, {98, 122, 36}, },
            {{48, 90, -8}, {97, 104, 36}, {105, 105, 41}, {106, 122, 36}, },
            {{48, 90, -8}, {97, 100, 36}, {101, 101, 42}, {102, 122, 36}, },
            {{48, 104, -28}, {105, 105, 43}, {106, 122, 36}, },
            {{48, 90, -8}, {97, 97, 44}, {98, 122, 36}, },
            {},
            {},
            {},
            {{0, 65535, -7}, },
            ...
            {{48, 122, -8}, },
            {{48, 122, -8}, },
            {{48, 100, -29}, {101, 101, 73}, {102, 122, 36}, },
            {{48, 122, -8}, },
        }
    };*/
...
/*  {
        // INITIAL
        {-1, 0, 0, 0, 17, -1, 29, 15, 7, 8, 5, 18, 2, 6, 3, 28, 31, 4, 14, 13, 30, 9, 10, 29, 29, 29, 29, 29, 29, 29, 11, 16, 12, -1, 1, 1, 29, 29, 29, 29, 29, 29, 29, 19, 29, 1, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 26, 29, 29, 29, 20, 29, 29, 23, 29, 21, 29, 27, 24, 25, 29, 22, },
